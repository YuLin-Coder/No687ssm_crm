			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div id="myTabContent" class="tab-content">
						<form action="expense/addExpense.action" name="myform" method="post" onsubmit="return check()" class="form">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>数量</label> 
									<input type="text" name="num" class="form-control" id="num" placeholder="请输入数量" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>付款方式</label> 
									<select name="paywayid" class="form-control" id="paywayid">
